...
<div class="body">
    ...
    <ul>
        ...
        <li>
            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                or &quot;Our&quot; in this Agreement) refers to not twitter, 1 bernstrasse, bern 3000.</p>
        </li>
        <li>
        ...
        <li>
            <p><strong>Website</strong> refers to not twitter, accessible from <a href="www.nottwitter.com"
                    rel="external nofollow noopener" target="_blank">www.nottwitter.com</a></p>
        </li>
        <li>
    ...
    <ul>
        <li>By email: support@nottwitter.ch</li>
    </ul>
    </div>
